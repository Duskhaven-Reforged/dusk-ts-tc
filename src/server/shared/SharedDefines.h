...
enum Powers : int8
{
    ...
    POWER_COMBO                         = 4,  // TITLE Combo Points
...
enum SpellAttr2 : uint32
{
    ...
    SPELL_ATTR2_CHAIN_FROM_CASTER                = 0x00001000, // TITLE Unknown attribute 12@Attr2
...
enum Targets
{
    ...
    TARGET_UNIT_SRC_AREA_OWNER_ALLY    = 114,
    TOTAL_SPELL_TARGETS
};
...
enum UnitDynFlags
{
    ...
    UNIT_DYNFLAG_LOOT_MOVED                 = 0x0100
};
