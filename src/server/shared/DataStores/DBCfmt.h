...
char constexpr SpellCastTimefmt[] = "niii";
char constexpr CustomSpellCastTimefmt[] = "pppp";
char constexpr CustomSpellCastTimeIndex[] = "ID";
...
char constexpr CustomSpellDurationfmt[] = "pppp";
char constexpr CustomSpellDurationIndex[] = "ID";
