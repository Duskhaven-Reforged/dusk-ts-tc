...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        void RemoveAurasWithInterruptFlags(uint32 flag, uint32 except = 0, Unit* attacker = nullptr, DamageEffectType damagetype = DIRECT_DAMAGE);
        ...
        bool HasDispellableAuraOfType(uint32 DispelMask) const;
    ...
    protected:
        ...
        void BuildValuesUpdate(uint8 updatetype, ByteBuffer* data, Player const* target) override;
    ...
    private:
        ...
        void PatchValuesUpdate(ByteBuffer& valuesUpdateBuf, BuildValuesCachePosPointers& posPointers, Player const* target);
