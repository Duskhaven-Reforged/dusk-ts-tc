...
enum EUnitFields
{
    ...
    PLAYER_CHARACTER_POINTS1                  = UNIT_END + 0x0368, // Size: 1, Type: INT, Flags: PRIVATE // Talent Points
    PLAYER_CHARACTER_POINTS2                  = UNIT_END + 0x0369, // Size: 1, Type: INT, Flags: PRIVATE // Prof Points
    ...
    PLAYER_MASTERY                            = UNIT_END + 0x036F, // Size: 1, Type: INT, Flags: PRIVATE
    ...
    PLAYER_FIELD_SPEED                        = UNIT_END + 0x0492, // Size: 1, Type: float, Flags: PRIVATE
    PLAYER_FIELD_LEECH                        = UNIT_END + 0x0493, // Size: 1, Type: float, Flags: PRIVATE
    PLAYER_FIELD_AVOIDANCE                    = UNIT_END + 0x0494, // Size: 1, Type: float, Flags: PRIVATE
    PLAYER_FIELD_WEAPON_BONUS_AP              = UNIT_END + 0x0495, // Size: 3, Type: INT, Flags: PRIVATE
