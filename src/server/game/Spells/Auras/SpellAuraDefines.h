...
enum AuraType : uint32
{
    ...
    SPELL_AURA_ADD_CHAGE                                    = 265,
    SPELL_AURA_MOD_CHARGE_CD                                = 266,
    ...
    SPELL_AURA_MOD_ARMOR_PENETRATION_PCT_FROM_CASTER        = 295,
    ...
    SPELL_AURA_MOD_CHANGE_DAMAGE_SCHOOL_OF_SPELL            = 302,
    ...
    oldSPELL_AURA_MOD_CHANGE_DAMAGE_SCHOOL_OF_SPELL         = 354,
