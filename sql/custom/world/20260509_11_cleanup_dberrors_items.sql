...
UPDATE `item_template` SET `stat_type2` = 0 WHERE `entry` = 22230 AND `stat_type2` = 50;
UPDATE `item_template` SET `stat_type3` = 0 WHERE (`entry`,`stat_type3`) IN ((20142,50),(20522,50),(20524,50),(21614,55));
UPDATE `item_template` SET `stat_type4` = 0 WHERE (`entry`,`stat_type4`) IN ((20142,51),(20524,54));
UPDATE `item_template` SET `stat_type5` = 0 WHERE (`entry`,`stat_type5`) IN ((20142,52),(23363,55));
UPDATE `item_template` SET `stat_type6` = 0 WHERE (`entry`,`stat_type6`) IN ((20142,54),(23363,56));
UPDATE `item_template` SET `stat_type7` = 0 WHERE `entry` = 20142 AND `stat_type7` = 55;
UPDATE `item_template` SET `stat_type8` = 0 WHERE `entry` = 20142 AND `stat_type8` = 56;

UPDATE `item_template` SET `sheath` = 2 WHERE `entry` = 60616;
UPDATE `item_template` SET `sheath` = 0 WHERE `entry` IN (60618,60628,61147);
